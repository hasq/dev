...
var imgBtnCreate = '<img width="40px" height="40px" ' +
    'src="img/btn_create.png"><br/>Create';
var imgBtnData = '<img width="40px" height="40px" ' +
    'src="img/btn_setdata.png"><br/>Set';
var imgBtnInstantKeys = '<img width="40px" height="40px" ' +
    'src="img/btn_show_keys1.png"><br/>Instant';
var imgBtnOnHoldKeys = '<img width="40px" height="40px" ' +
    'src="img/btn_show_keys2.png"><br/>On Hold';
var imgBtnReleaseKeys = '<img width="40px" height="40px" ' +
    'src="img/btn_show_keys3.png"><br/>Release';
var imgBtnReceiveKeys = '<img width="40px" height="40px" ' +
    'src="img/btn_accept.png"><br/>Accept';
var imgBtnStop = '<img width="40px" height="40px" ' +
    'src="img/btn_stop.gif"><br/>Stop';
var imgBtnStart = '<img width="40px" height="40px" ' +
    'src="img/btn_search.png"><br/>Search';
var imgTabShowKeys = '<img width="40px" height="40px" ' +
    'src="img/tab_send.png"><br/>Give';
var imgTabReceiveKeys = '<img width="40px" height="40px" ' +
    'src="img/tab_receive.png"><br/>Receive';
var imgTabSearchTokens = '<img width="40px" height="40px" ' +
    'src="img/tab_view.png"><br/>Lookup';
var imgBtnSearchMine = '<img width="24px" height="16px" ' +
    'src="img/pwd_good.png" title="Mine tokens">';
var imgBtnSearchOnHold = '<img width="24px" height="16px" ' +
    'src="img/pwd_sndng.png" title="Tokens on hold">';
var imgBtnSearchExpected = '<img width="24px" height="16px" ' +
    'src="img/pwd_rcvng.png" title="Tokens to come">';
var imgBtnStartPast = '<img width="24px" height="16px" ' +
    'src="img/pwd_wrong.png" title="Past tokens">';
