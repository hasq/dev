...
function widGetHTMLRecTabTokArea() {
	...
	r += '<table>\n';
		r += '<tr>\n';
			r += '<td colspan="2" class="records-title-td" />\n';
				r += '<b>&nbsp;Current DB:</b>\n';
...
function widGetHTMLRecTabPwdArea() {
	...
	r += '<table border="0">';
		r += '<tr>\n';
			r += '<td class="records-title-td" colspan="2"/>\n';
				r += '<b>&nbsp;New record</b>\n';
		r += '</tr>\n';
		r += '<tr>\n';
			r += '<td colspan="2" height="5px"/>';
		r += '</tr>\n';		
		r += '<tr>\n';
			r += '<td class="label-td" width="40%" align="left" />\n';
...
function widGetHTMLRecTabHistoryMenuArea() {
	...
	r += '<table>';
		r += '<tr>\n';
			r += '<td class="records-title-td" width="50%">\n';
				r += '<b>&nbsp;History</b>\n';	
