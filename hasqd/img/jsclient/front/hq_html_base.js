...
function widGetHTMLRecTabTokArea()
{
 ...
 r += '</tr>\n';
    r += '<tr>\n';
 r += '<td class="td-label"/>\n';
 r += '<label for="input_rdn">Raw token</label>\n';
 r += '<td/>\n';
    r += '<input type="text" id="input_rdn" oninput="return widTokenNameOninput()">\n';
 r += '</tr>\n';
    r += '<tr>\n';
 r += '<td class="td-label"/>\n';
 r += '<label for="input_dn">Token</label>\n';
 r += '<td/>\n';
    r += '<input type="text" id="input_dn" oninput="return widTokenHashOninput()">\n';
 r += '</tr>\n';
    r += '<tr>\n';
...
function widGetHTMLRecTabSubmitArea()
{
 ...
 r += '<button id="button_submit" onclick="widSubmitButtonClick()">Submit</button>\n';
 r += '</tr>\n';
 r += '</table>\n';
...
function widGetHTMLRecTabHistoryArea()
{
    ...
    r += '<td class="td-records-title td-50">\n';
                r += '<b>&nbsp;History</b>\n';
            r += '<td class="td-50"/>';
    r += '<table id="table_select_history">';
    r += '<tr>';
    r += '<td id="td_select_records_history">\n';
    r += '<select id="select_records_history">\n';
...
function widGetHTMLCommandTab()
{
 ...
 r += '<button id="button_cmd" type="submit" onclick="widCommandSendButtonClick()">Send</button>\n';
 r += '<td/>\n';
 r += '<input type="text" id="input_cmd" oninput="return $(\'#textarea_cmd\').val(\'\');" onkeypress="return widSendCommandInputOnpresskey($(this), event);"/>\n';
 r += '<td id="td_skc"/>\n';
