...
r = ts_lib.get_record(0, ts_lib.get_tok_hash(token_name, ts_cnf.HASH_NAME), master_key, ts_cnf.MAGIC, ts_cnf.HASH_NAME)
d = token_name if token_name != ts_lib.get_tok_hash(token_name, ts_cnf.HASH_NAME) else ""

http_rqst = ts_lib.get_spaced_conc(CMD, "*", ts_cnf.DB, str(r.get("n")), r.get("s"), r.get("k"), r.get("g"), r.get("o"), d)
